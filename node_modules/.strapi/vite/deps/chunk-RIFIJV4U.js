...
var ActionOption = ({ selected, actionType, handleChange, name, disabled = false }) => {
  return (0, import_jsx_runtime2.jsx)(FieldWrapper, {
    ...
    children: (0, import_jsx_runtime2.jsxs)(Field.Label, {
      children: [
        (0, import_jsx_runtime2.jsx)(VisuallyHidden, {
          children: (0, import_jsx_runtime2.jsx)(Field.Input, {
            type: "radio",
            name,
...
var ReleaseActionOptions = ({ selected, handleChange, name, disabled = false }) => {
  return (0, import_jsx_runtime2.jsxs)(Flex, {
    children: [
      (0, import_jsx_runtime2.jsx)(ActionOption, {
        actionType: "publish",
        selected,
        handleChange,
        name,
...
var DeleteReleaseActionItem = ({ releaseId, actionId }) => {
  ...
  return (0, import_jsx_runtime3.jsx)(Menu.Item, {
    variant: "danger",
    startIcon: (0, import_jsx_runtime3.jsx)(ForwardRef$45, {}),
...
var ReleaseActionEntryLinkItem = ({ contentTypeUid, documentId, locale }) => {
  ...
  return (0, import_jsx_runtime3.jsx)(StyledMenuLink, {
    ...
    startIcon: (0, import_jsx_runtime3.jsx)(ForwardRef$1v, {}),
    children: formatMessage({
...
var Root = ({ children }) => {
  ...
  return (
    ...
    allowedActions.canDeleteAction || allowedActions.canUpdate ? (0, import_jsx_runtime3.jsxs)(Menu.Root, {
      children: [
        (0, import_jsx_runtime3.jsx)(StyledMoreButton, {
          variant: "tertiary",
          endIcon: null,
          paddingLeft: "7px",
          paddingRight: "7px",
          children: (0, import_jsx_runtime3.jsx)(AccessibleIcon, {
            label: formatMessage({
        ...
        (0, import_jsx_runtime3.jsx)(Menu.Content, {
          top: 1,
...
//# sourceMappingURL=chunk-RIFIJV4U.js.map
