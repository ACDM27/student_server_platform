import {
  ...
  require_throttle,
  z
} from "./chunk-EFHTTJY3.js";
import {
  ADMIN_PERMISSIONS_CE,
  HOOKS
} from "./chunk-LJLS2DW6.js";
import {
  useNpsSurveySettings
} from "./chunk-WSXYE5QV.js";
import {
  img
...
import {
  QueryClient,
  QueryClientProvider
} from "./chunk-343OTFBC.js";
import {
  GuidedTourProvider,
  useGuidedTour
} from "./chunk-3ZDTXCAV.js";
import {
  require_pick
} from "./chunk-PVYHQI53.js";
import {
  getBasename
} from "./chunk-QIJGNK42.js";
import {
  useClipboard
} from "./chunk-SL4XJTUD.js";
import {
  useEnterprise
} from "./chunk-ENZ6M6UM.js";
import {
  Login
} from "./chunk-T5UL4PIA.js";
import {
  MemoizedInputRenderer
} from "./chunk-VOZ6J4FJ.js";
import {
  Form
} from "./chunk-G2VSF5GD.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-QE6UH645.js";
import {
  ConfigurationProvider
} from "./chunk-ORF44PZ5.js";
import {
  require_merge,
  require_omit
} from "./chunk-4RQE36J6.js";
import {
  HistoryProvider
} from "./chunk-JMI7LPLL.js";
import {
  errorsTrads
...
import {
  TrackingProvider,
  useTracking
} from "./chunk-W65VJ5OT.js";
import {
  createAbsoluteUrl,
  useGetGuidedTourMetaQuery,
  useInitQuery
} from "./chunk-XNJL77D3.js";
import {
  getByteSize
...
} from "./chunk-TLHDHNYG.js";
import {
  useTypedDispatch,
  useTypedSelector,
  useTypedStore
} from "./chunk-MRMFNXLR.js";
import {
...
import {
  ...
  isRejected,
  useDispatch
} from "./chunk-UZO674YT.js";
import {
  createContext
} from "./chunk-TFEDHJAK.js";
import {
  require_isFunction
              ...
              children: [
                ...
                (0, import_jsx_runtime8.jsx)(Typography, {
                  ...
                  children: formatMessage({
                    ...
                    link: (0, import_jsx_runtime8.jsx)(Link, {
                      isExternal: true,
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-2KNTCQDE.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-VPB3YEHH.js");
        return {
      ...
      children: [
        ...
        (0, import_jsx_runtime14.jsx)(Flex, {
          ...
          children: (0, import_jsx_runtime14.jsx)(Box, {
            paddingTop: 4,
            children: (0, import_jsx_runtime14.jsx)(Link, {
              tag: NavLink,
              to: "/auth/login",
              children: formatMessage({
                id: "Auth.link.ready",
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-NRIWIREE.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-H3LLN5HR.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-PUHOFAHW.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-TWAM7VIZ.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-UGJ76ZQK.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-UBELTSYO.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-B4VBRI5R.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-SHLRIA7A.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-PUWNM62T.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-6OZYZABS.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-IGHHHKFV.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-XJTHIW5H.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-SJ4CXXSI.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-5BQPAXPY.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-H4GHKGVD.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-QSGVNLUL.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-57LPXYJP.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-AJZVTR2J.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-HPTSBUVL.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-CCSXVR42.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-AWGVZKZB.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-PNB2SJQX.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-NWCTJDQ2.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-BR7UGLXJ.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-PUUX4SDM.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-GC35NBXD.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-OMLX6Q4U.js");
              return {
...
//# sourceMappingURL=chunk-FICQS5RO.js.map
