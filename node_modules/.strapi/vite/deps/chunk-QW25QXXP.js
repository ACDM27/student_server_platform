...
import {
  reducer
} from "./chunk-NB6YLULU.js";
import {
  DEFAULT_BULK_ACTIONS,
  DEFAULT_TABLE_ROW_ACTIONS
} from "./chunk-U5MPEUL2.js";
import {
  ActionsPanel,
  DEFAULT_ACTIONS,
...
var index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-CNNUP3US.js");
        return {
          Component: Layout
        };
      },
    ...
    app.widgets.register([
      {
        ...
        component: async () => {
          const { LastEditedWidget } = await import("./Widgets-E4QJCTTO.js");
      ...
      },
      {
        ...
        component: async () => {
          const { LastPublishedWidget } = await import("./Widgets-E4QJCTTO.js");
...
//# sourceMappingURL=chunk-QW25QXXP.js.map
