...
// node_modules/@strapi/admin/node_modules/@strapi/icons/dist/index.mjs
...
// node_modules/@strapi/admin/node_modules/@strapi/design-system/dist/index.mjs
var React2 = __toESM(require_react(), 1);
var import_react2 = __toESM(require_react(), 1);
var import_jsx_runtime3 = __toESM(require_jsx_runtime(), 1);

// node_modules/@strapi/admin/node_modules/@strapi/ui-primitives/dist/index.mjs
var import_jsx_runtime2 = __toESM(require_jsx_runtime(), 1);
var React = __toESM(require_react(), 1);

// node_modules/@strapi/admin/node_modules/aria-hidden/dist/es2015/index.js
...
var Combobox = (props) => {
  ...
  const focusFirst = React.useCallback(
    (candidates, items) => {
      ...
      const PREVIOUSLY_FOCUSED_ELEMENT = visuallyFocussedItem ?? ((_a2 = items.find((item) => item.value === value)) == null ? void 0 : _a2.ref.current);
      ...
      children: (0, import_jsx_runtime2.jsx)(
        "div",
        {
          ...
          onClick: $e42e1063c40fb3ef$export$b9ecd428b558ff10(triggerProps.onClick, (event) => {
            ...
            (_a2 = context.trigger) == null ? void 0 : _a2.focus();
          }),
...
var ComboxboxTextInput = React.forwardRef((props, forwardedRef) => {
  ...
  $9f79659886946c16$export$e5c5a5f917a5871c(() => {
    const timeout = setTimeout(() => {
      ...
      if (firstItem && !context.visuallyFocussedItem && characterChangedAtIndex === context.filterValue.length) {
        (_a3 = inputRef.current) == null ? void 0 : _a3.setSelectionRange(context.filterValue.length, context.textValue.length);
      }
    });
  ...
  return (0, import_jsx_runtime2.jsx)(
    "input",
    {
      ...
      "aria-activedescendant": (_a2 = context.visuallyFocussedItem) == null ? void 0 : _a2.id,
      disabled: isDisabled,
        ...
        if (["ArrowUp", "ArrowDown", "Home", "End"].includes(event.key)) {
          ...
          setTimeout(() => {
            ...
            if (["ArrowUp", "ArrowDown"].includes(event.key)) {
              const currentElement = context.visuallyFocussedItem ?? ((_a4 = getItems().find((item) => item.value === context.value)) == null ? void 0 : _a4.ref.current);
              if (currentElement) {
          ...
          if (context.visuallyFocussedItem) {
            ...
            if (focussedItem) {
              ...
              (_a3 = focussedItem.ref.current) == null ? void 0 : _a3.click();
            }
          } else {
      ...
      onKeyUp: $e42e1063c40fb3ef$export$b9ecd428b558ff10(props.onKeyUp, (event) => {
        ...
        if (context.autocomplete.type === "none" && context.isPrintableCharacter(event.key)) {
          ...
          if (nextItem) {
            ...
            (_a3 = nextItem.ref.current) == null ? void 0 : _a3.scrollIntoView();
          }
        }
      }),
...
var ComboboxItem = React.forwardRef((props, forwardedRef) => {
  ...
  const { startsWith: startsWith4, contains } = useFilter(context.locale, { sensitivity: "base" });
  ...
  if (context.autocomplete.type === "both" && textValue && context.filterValue && !startsWith4(textValue, context.filterValue) || context.autocomplete.type === "list" && context.autocomplete.filter === "startsWith" && textValue && contextTextValue && !startsWith4(textValue, contextTextValue) || context.autocomplete.type === "list" && context.autocomplete.filter === "contains" && textValue && contextTextValue && !contains(textValue, contextTextValue)) {
...
var ComboboxItemImpl = React.forwardRef((props, forwardedRef) => {
  ...
  const isFocused = React.useMemo(() => {
    var _a2;
    return visuallyFocussedItem === ((_a2 = getItems().find((item) => item.ref.current === itemRef.current)) == null ? void 0 : _a2.ref.current);
...
var ComboboxNoValueFound = React.forwardRef((props, ref) => {
  ...
  const { startsWith: startsWith4, contains } = useFilter(locale, { sensitivity: "base" });
  React.useEffect(() => {
      ...
      if (Array.isArray(context.value) && valuedItems.length !== context.value.length) {
        const timeout = setTimeout(() => {
          const valuedItems2 = getItems().filter(
            (item) => {
              var _a2;
              return !Array.isArray(item.value) ? (_a2 = context.value) == null ? void 0 : _a2.includes(item.value) : false;
            }
          );
    ...
    const itemTextRefCallback = React.useCallback(
      (node, value, disabled) => {
        ...
        const isSelectedItem = context.value !== void 0 && (Array.isArray(value) ? value.every((v) => {
          var _a2;
          return (_a2 = context.value) == null ? void 0 : _a2.includes(v);
        }) : context.value === value);
        if (isSelectedItem || isFirstValidItem) {
...
var createContext2 = (rootComponentName, defaultContext) => {
  const Context2 = React2.createContext(defaultContext);
  ...
  function useContext3(consumerName) {
    const context = React2.useContext(Context2);
    if (context)
      return context;
...
var AlertIcon = ({ variant: variant2, ...props }) => {
  if (variant2 === "success") {
    return (0, import_jsx_runtime3.jsx)(ForwardRef$4D, { ...props });
  }
  if (variant2 === "danger" || variant2 === "warning") {
    return (0, import_jsx_runtime3.jsx)(ForwardRef$3, { ...props });
  }
  return (0, import_jsx_runtime3.jsx)(ForwardRef$2D, { ...props });
};
      ...
      children: [
        ...
        (0, import_jsx_runtime3.jsx)(
          CloseButton,
          {
            ...
            onClick: onClose,
            color: "neutral700",
            children: (0, import_jsx_runtime3.jsx)(AccessibleIcon, { label: closeLabel, children: (0, import_jsx_runtime3.jsx)(ForwardRef$45, {}) })
          }
        )
      ]
    }
...
var CardAsset = ({ size = "M", children, ...props }) => {
  return (0, import_jsx_runtime3.jsx)(CardAssetWrapper, { $size: size, children: children ? children : (0, import_jsx_runtime3.jsx)(CardAssetImg, { ...props, "aria-hidden": true }) });
};
...
var DesignSystemProvider = ({
  ...
  return (0, import_jsx_runtime3.jsx)(Provider, { locale, children: (0, import_jsx_runtime3.jsxs)(ot, { theme, children: [
    (0, import_jsx_runtime3.jsx)($a093c7e1ec25a057$export$2881499e37b75b9a, { ...tooltipConfig, children }),
...
var Portal$12 = React2.forwardRef(
  ({ container = ((_a2) => (_a2 = globalThis == null ? void 0 : globalThis.document) == null ? void 0 : _a2.body)(), ...portalProps }, forwardedRef) => {
        ...
        children: (0, import_jsx_runtime3.jsx)(
          TriggerElement,
          {
            ...
            onClick: composeEventHandlers(restProps.onClick, () => {
              var _a2;
              (_a2 = context.textInput) == null ? void 0 : _a2.focus();
            }),
...
var DatePickerTextInput = React2.forwardRef(
  ({ placeholder, ...props }, forwardedRef) => {
    ...
    const [dateFormatPlaceholder, separator, dateStructure] = React2.useMemo(() => {
      ...
      const separator2 = ((_a2 = parts.find((part) => part.type === "literal")) == null ? void 0 : _a2.value) ?? "";
...
var JSONInput = React2.forwardRef(
  ({
    ...
    const highglightErrorAtLine = (lineNumber) => {
      var _a2, _b;
      const doc = (_a2 = editorState.current) == null ? void 0 : _a2.doc;
      if (doc) {
...
var Pagination = ({ children, label = "Pagination", activePage, pageCount }) => {
  ...
  return (0, import_jsx_runtime3.jsx)(PaginationContext.Provider, { value: context, children: (0, import_jsx_runtime3.jsx)(Box, { "aria-label": label, tag: "nav", children: (0, import_jsx_runtime3.jsx)(Flex, { tag: "ol", gap: 1, children: React2.Children.map(children, (child, index) => {
    return (0, import_jsx_runtime3.jsx)("li", { children: child }, index);
  }) }) }) });
};
  ...
  ({ coords = { col: 0, row: 0 }, tag = "td", ...props }, forwardedRef) => {
    ...
    const handleKeyDown = (e) => {
      ...
      if (isEnterKey && !isActive) {
        ...
        if (isEnterKey && ((_a2 = document.activeElement) == null ? void 0 : _a2.tagName) === "A") {
          return;
        }
        setIsActive(false);
        tdRef.current.focus();
...
var createIntl2 = function(_a2, cache2) {
  var rawDefaultRichTextElements = _a2.defaultRichTextElements, config = __rest(_a2, ["defaultRichTextElements"]);
  var defaultRichTextElements = assignUniqueKeysToFormatXMLElementFnArgument(rawDefaultRichTextElements);
  var coreIntl = createIntl(__assign(__assign(__assign({}, DEFAULT_INTL_CONFIG2), config), { defaultRichTextElements }), cache2);
  var resolvedConfig = {
  ...
  function(_super) {
    ...
    IntlProvider3.getDerivedStateFromProps = function(props, _a2) {
      ...
      if (!shallowEqual(prevConfig, config)) {
        return {
          intl: createIntl2(config, cache2),
          prevConfig: config
        };
      }
      return null;
    ...
    IntlProvider3.prototype.render = function() {
      ...
      return React8.createElement(Provider2, { value: this.state.intl }, this.props.children);
    };
...
var FormattedPlural = function(props) {
  ...
  if (Text) {
    return React10.createElement(Text, null, formattedPlural);
  }
...
function FormattedMessage(props) {
  var intl = useIntl();
  var formatMessage3 = intl.formatMessage, _a2 = intl.textComponent, Text = _a2 === void 0 ? React11.Fragment : _a2;
  ...
  if (Component) {
    return React11.createElement(Component, null, React11.Children.toArray(nodes));
  }
  return React11.createElement(React11.Fragment, null, nodes);
}
FormattedMessage.displayName = "FormattedMessage";
var MemoizedFormattedMessage = React11.memo(FormattedMessage, areEqual);
...
var FormattedDateTimeRange = function(props) {
  ...
  var Text = intl.textComponent || React12.Fragment;
  return React12.createElement(Text, null, formattedValue);
};
...
//# sourceMappingURL=chunk-G23CFI62.js.map
