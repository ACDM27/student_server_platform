...
// node_modules/.pnpm/strapi-plugin-component-doc_8592e3ec0504b36b50d091420b84e5ad/node_modules/strapi-plugin-component-docs/dist/admin/index.mjs
...
`;
var PluginIcon = () => {
  return (0, import_jsx_runtime.jsx)(IconBox, { justifyContent: "center", alignItems: "center", width: 7, height: 6, hasRadius: true, "aria-hidden": true, children: (0, import_jsx_runtime.jsx)(ForwardRef$2v, {}) });
};
var map;
try {
  map = Map;
...
var symbolToString$1 = typeof Symbol !== "undefined" ? Symbol.prototype.toString : () => "";
...
var index = {
  register(app) {
    ...
    app.customFields.register({
      ...
      components: {
        Input: async () => import("./Input-CTlgDp-Y-RGSLS362.js")
      },
      options: {
        base: [
          {
        ...
        validator: (args) => {
          ...
          const createValidation2 = (fieldValue) => {
            const baseSchema = create().required(errorMessages.required);
  ...
  async registerTrads({ locales }) {
    return Promise.all(
      locales.map(async (locale) => {
        try {
          const { default: data } = await __variableDynamicImportRuntimeHelper(Object.assign({ "./translations/en.json": () => import("./en-BfMZFvE2-3ERHHPQC.js") }), `./translations/${locale}.json`, 3);
          return {
            data: data || {},
            locale
          };
...
//# sourceMappingURL=strapi-plugin-component-docs_strapi-admin.js.map
