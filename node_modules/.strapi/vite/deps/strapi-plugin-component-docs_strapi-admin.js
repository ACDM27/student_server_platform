...
// node_modules/strapi-plugin-component-docs/dist/admin/index.mjs
...
`;
var PluginIcon = () => {
  return (0, import_jsx_runtime.jsx)(IconBox, { justifyContent: "center", alignItems: "center", width: 7, height: 6, hasRadius: true, "aria-hidden": true, children: (0, import_jsx_runtime.jsx)(ForwardRef$2r, {}) });
};
var map;
try {
  map = Map;
...
var index = {
  register(app) {
    ...
    app.customFields.register({
      ...
      components: {
        Input: async () => import("./Input-CTlgDp-Y-AU64DZ4L.js")
      },
      options: {
        base: [
          {
  ...
  async registerTrads({ locales }) {
    return Promise.all(
      locales.map(async (locale) => {
        try {
          const { default: data } = await __variableDynamicImportRuntimeHelper(Object.assign({ "./translations/en.json": () => import("./en-BfMZFvE2-K3MASCKS.js") }), `./translations/${locale}.json`, 3);
          return {
            data: data || {},
            locale
          };
