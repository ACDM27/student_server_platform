...
// node_modules/.pnpm/@strapi+icons@2.0.0-rc.29_r_ebc367a8d8db1c06fbc766e1261dfa3c/node_modules/@strapi/icons/dist/index.mjs
...
// node_modules/.pnpm/@strapi+design-system@2.0.0_12ba0d33b2b15fc5dc3596e1a035b48f/node_modules/@strapi/design-system/dist/index.mjs
var React2 = __toESM(require_react(), 1);
var import_react2 = __toESM(require_react(), 1);
var import_jsx_runtime3 = __toESM(require_jsx_runtime(), 1);

// node_modules/.pnpm/@strapi+ui-primitives@2.0.0_7f298209c6f4f05668a4a703354897f8/node_modules/@strapi/ui-primitives/dist/index.mjs
...
var Trigger$7 = React2.forwardRef(
  ({ caretPosition = "left", description, icon: Icon2, iconProps, children, ...restProps }, forwardedRef) => {
    ...
    return (0, import_jsx_runtime3.jsxs)(AccordionTrigger, { $caretPosition: caretPosition, $size: size, ref: forwardedRef, ...restProps, children: [
      caretPosition === "left" ? (0, import_jsx_runtime3.jsx)(TriggerIcon, { $size: size, children: (0, import_jsx_runtime3.jsx)(ForwardRef$4$, { width: size === "S" ? "1.2rem" : "1.6rem", height: size === "S" ? "1.2rem" : "1.6rem" }) }) : null,
      ...
      caretPosition === "right" ? (0, import_jsx_runtime3.jsx)(TriggerIcon, { $size: size, children: (0, import_jsx_runtime3.jsx)(ForwardRef$4$, { width: size === "S" ? "1.2rem" : "1.6rem", height: size === "S" ? "1.2rem" : "1.6rem" }) }) : null
    ] });
  }
);
...
var AlertIcon = ({ variant: variant2, ...props }) => {
  if (variant2 === "success") {
    return (0, import_jsx_runtime3.jsx)(ForwardRef$4L, { ...props });
  }
  if (variant2 === "danger" || variant2 === "warning") {
    return (0, import_jsx_runtime3.jsx)(ForwardRef$5, { ...props });
  }
  return (0, import_jsx_runtime3.jsx)(ForwardRef$2H, { ...props });
};
      ...
      children: [
        ...
        (0, import_jsx_runtime3.jsx)(
          CloseButton,
          {
            ...
            onClick: onClose,
            color: "neutral700",
            children: (0, import_jsx_runtime3.jsx)(AccessibleIcon, { label: closeLabel, children: (0, import_jsx_runtime3.jsx)(ForwardRef$4d, {}) })
          }
        )
      ]
    }
...
`;
var LoaderAnimated = dt(ForwardRef$2n)`
...
var Link = forwardRef4(
  ({ children, href, disabled = false, startIcon, endIcon, isExternal = false, ...props }, ref) => {
    return (0, import_jsx_runtime3.jsxs)(LinkWrapper$1, { ref, href, disabled, isExternal, ...props, children: [
      ...
      endIcon,
      href && !endIcon && isExternal && (0, import_jsx_runtime3.jsx)(ForwardRef$3N, {})
    ] });
  }
);
...
var MenuTrigger = React2.forwardRef(
  ({ label, endIcon = (0, import_jsx_runtime3.jsx)(ForwardRef$4$, { width: "1.2rem", height: "1.2rem", "aria-hidden": true }), tag = Button, icon, ...rest }, ref) => {
    const props = {
      ...rest,
      ref,
      type: "button"
  ...
  return (0, import_jsx_runtime3.jsx)($d08ef79370b62062$export$2ea8a7a591ac5eac, { asChild: true, disabled, children: (0, import_jsx_runtime3.jsxs)(
    SubmenuTrigger,
    {
      ...
      children: [
        ...
        (0, import_jsx_runtime3.jsx)(ForwardRef$4D, { fill: "neutral500", height: "1.2rem", width: "1.2rem" })
      ]
    }
  ) });
});
...
var CheckboxEl = React2.forwardRef(
  ({ defaultChecked, checked: checkedProp, onCheckedChange, ...props }, forwardedRef) => {
    ...
    return (0, import_jsx_runtime3.jsx)(CheckboxRoot, { ref: composedRefs, checked, onCheckedChange: setChecked, ...props, children: (0, import_jsx_runtime3.jsxs)(CheckboxIndicator, { forceMount: true, children: [
      ...
      checked === "indeterminate" ? (0, import_jsx_runtime3.jsx)(ForwardRef$25, { fill: "neutral0" }) : null
    ] }) });
  }
);
        ...
        CarouselGrid,
        {
          ...
          children: [
            childrenArray && childrenArray.length > 1 && (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
              (0, import_jsx_runtime3.jsx)(CarouselAction, { tag: "button", onClick: onPrevious, $area: "startAction", ref: prevActionRef, type: "button", children: (0, import_jsx_runtime3.jsx)(AccessibleIcon, { label: previousLabel, children: (0, import_jsx_runtime3.jsx)(ForwardRef$4F, { width: "1.6rem", height: "1.6rem", fill: "neutral600" }) }) }),
              (0, import_jsx_runtime3.jsx)(CarouselAction, { tag: "button", onClick: onNext, $area: "endAction", ref: nextActionRef, type: "button", children: (0, import_jsx_runtime3.jsx)(AccessibleIcon, { label: nextLabel, children: (0, import_jsx_runtime3.jsx)(ForwardRef$4D, { width: "1.6rem", height: "1.6rem", fill: "neutral600" }) }) })
            ] }),
        ...
        children: [
          (0, import_jsx_runtime3.jsxs)(Trigger$5, { $hasError: hasError, $size: size, className, children: [
            ...
            (0, import_jsx_runtime3.jsxs)(Flex, { tag: "span", gap: 3, children: [
              ...
              (0, import_jsx_runtime3.jsx)(DownIcon$1, { children: (0, import_jsx_runtime3.jsx)(ForwardRef$4$, { fill: "neutral500" }) })
            ] })
          ] }),
      ...
      StyledTrigger,
      {
        ...
        children: [
          ...
          (0, import_jsx_runtime3.jsxs)(Flex, { tag: "span", gap: 3, children: [
            ...
            (0, import_jsx_runtime3.jsx)(DownIcon, { children: (0, import_jsx_runtime3.jsx)(ForwardRef$4$, {}) })
          ] })
        ]
      }
    ) });
      ...
      DatePickerProvider,
      {
        ...
        children: [
          (0, import_jsx_runtime3.jsxs)(DatePickerTrigger, { className, hasError, size, children: [
            (0, import_jsx_runtime3.jsx)(ForwardRef$53, { fill: "neutral500", "aria-hidden": true }),
  ...
  ({ step = 15, value: valueProp, defaultValue, onChange, ...restProps }, forwardedRef) => {
    ...
    return (0, import_jsx_runtime3.jsx)(
      TimePickerCombobox,
      {
        ...
        autocomplete: "none",
        startIcon: (0, import_jsx_runtime3.jsx)(ForwardRef$4z, { fill: "neutral500" }),
        inputMode: "numeric",
        pattern,
        textValue,
        onTextValueChange: handleTextValueChange,
  ...
  ({ children, closeLabel = "Close modal", ...restProps }, forwardedRef) => {
    return (0, import_jsx_runtime3.jsxs)(
      Head,
      {
        ...
        children: [
          children,
          (0, import_jsx_runtime3.jsx)(Close, { children: (0, import_jsx_runtime3.jsx)(IconButton, { withTooltip: false, label: closeLabel, children: (0, import_jsx_runtime3.jsx)(ForwardRef$4d, {}) }) })
        ]
      }
    );
  }
        ...
        endAction: (0, import_jsx_runtime3.jsxs)(Flex, { direction: "column", children: [
          (0, import_jsx_runtime3.jsx)(
            ArrowButton,
            {
              ...
              type: "button",
              "data-testid": "ArrowUp",
              children: (0, import_jsx_runtime3.jsx)(ForwardRef$4$, { fill: "neutral500" })
            }
          ),
          (0, import_jsx_runtime3.jsx)(
            ArrowButton,
...
var PreviousLink = forwardRef4(
  ({ children, ...props }, ref) => {
    ...
    return (0, import_jsx_runtime3.jsxs)(ActionLinkWrapper, { ref, "aria-disabled": disabled, tabIndex: disabled ? -1 : void 0, ...props, children: [
      (0, import_jsx_runtime3.jsx)(VisuallyHidden, { children }),
      (0, import_jsx_runtime3.jsx)(ForwardRef$4F, { "aria-hidden": true })
    ] });
  }
);
var NextLink = forwardRef4(
  ({ children, ...props }, ref) => {
    ...
    return (0, import_jsx_runtime3.jsxs)(ActionLinkWrapper, { ref, "aria-disabled": disabled, tabIndex: disabled ? -1 : void 0, ...props, children: [
      (0, import_jsx_runtime3.jsx)(VisuallyHidden, { children }),
      (0, import_jsx_runtime3.jsx)(ForwardRef$4D, { "aria-hidden": true })
    ] });
  }
);
...
var CloseIcon = dt(ForwardRef$4d)`
  font-size: 0.5rem;
  path {
    fill: ${({ theme }) => theme.colors.neutral500};
  }
`;
var SearchIcon = dt(ForwardRef$$)`
  font-size: 1rem;
  path {
    fill: ${({ theme }) => theme.colors.neutral500};
  }
      ...
      if (arg && typeof arg === "object" && arg.value) {
        return (0, import_jsx_runtime3.jsx)(
          Tag,
          {
            tabIndex: -1,
            disabled,
            icon: (0, import_jsx_runtime3.jsx)(ForwardRef$4d, { width: `${14 / 16}rem`, height: `${14 / 16}rem` }),
  ...
  ({ children, startIcon, endIcon, disabled = false, loading = false, ...props }, ref) => {
    ...
    return (0, import_jsx_runtime3.jsxs)(
      TextButtonWrapper,
      {
        ...
        ...props,
        children: [
          loading ? (0, import_jsx_runtime3.jsx)(LoadingWrapper, { "aria-hidden": true, children: (0, import_jsx_runtime3.jsx)(ForwardRef$2n, {}) }) : startIcon,
...
//# sourceMappingURL=chunk-IIICAW4I.js.map
