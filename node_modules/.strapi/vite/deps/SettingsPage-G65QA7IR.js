...
var CreateLocale = ({ disabled, variant = "default" }) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(Modal.Root, {
    ...
    children: [
      (0, import_jsx_runtime2.jsx)(Modal.Trigger, {
    ...
    children: (0, import_jsx_runtime2.jsxs)(Form, {
      ...
      children: [
        ...
        (0, import_jsx_runtime2.jsx)(Modal.Body, {
          children: (0, import_jsx_runtime2.jsxs)(Tabs.Root, {
            variant: "simple",
            defaultValue: "basic",
            children: [
              (0, import_jsx_runtime2.jsxs)(Flex, {
                ...
                children: [
                  ...
                  (0, import_jsx_runtime2.jsxs)(Tabs.List, {
...
var BaseForm = ({ mode = "create" }) => {
  ...
  return (0, import_jsx_runtime2.jsx)(Grid.Root, {
    gap: 4,
    children: translatedForm.map(({ size, ...field }) => (0, import_jsx_runtime2.jsx)(Grid.Item, {
      col: size,
      direction: "column",
      alignItems: "stretch",
...
var AdvancedForm = ({ isDefaultLocale }) => {
  ...
  return (0, import_jsx_runtime2.jsx)(Grid.Root, {
    gap: 4,
    children: form.map(({ size, ...field }) => (0, import_jsx_runtime2.jsx)(Grid.Item, {
      col: size,
      direction: "column",
      alignItems: "stretch",
      children: (0, import_jsx_runtime2.jsx)(FormRenderer, {
...
var EditLocale = (props) => {
  ...
  return (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, {
    children: [
      (0, import_jsx_runtime4.jsx)(IconButton, {
        onClick: () => setVisible(true),
        label: formatMessage({
...
var EditModal = ({ id, code, isDefault, name, open, onOpenChange }) => {
  ...
  return (0, import_jsx_runtime4.jsx)(Modal.Root, {
    open,
    onOpenChange,
    children: (0, import_jsx_runtime4.jsx)(Modal.Content, {
      children: (0, import_jsx_runtime4.jsxs)(Form, {
        ...
        validationSchema: LOCALE_SCHEMA,
        children: [
          (0, import_jsx_runtime4.jsx)(Modal.Header, {
          ...
          (0, import_jsx_runtime4.jsx)(Modal.Body, {
            children: (0, import_jsx_runtime4.jsxs)(Tabs.Root, {
              variant: "simple",
              defaultValue: "basic",
              children: [
          ...
          (0, import_jsx_runtime4.jsxs)(Modal.Footer, {
            children: [
              (0, import_jsx_runtime4.jsx)(Modal.Close, {
...
var LocaleTable = ({ locales = [], canDelete, canUpdate }) => {
  ...
  return (0, import_jsx_runtime5.jsxs)(Table, {
    colCount: 4,
    rowCount: locales.length + 1,
    children: [
      (0, import_jsx_runtime5.jsx)(Thead, {
        children: (0, import_jsx_runtime5.jsxs)(Tr, {
          children: [
            (0, import_jsx_runtime5.jsx)(Th, {
            ...
            (0, import_jsx_runtime5.jsx)(Th, {
              children: (0, import_jsx_runtime5.jsx)(VisuallyHidden, {
                children: "Actions"
              })
            })
          ]
  ...
  return (0, import_jsx_runtime6.jsxs)(Page.Main, {
    ...
    children: [
      ...
      (0, import_jsx_runtime6.jsx)(Layouts.Content, {
        children: locales.length > 0 ? (0, import_jsx_runtime6.jsx)(LocaleTable, {
          locales,
          canDelete,
          canUpdate
        }) : (0, import_jsx_runtime6.jsx)(EmptyStateLayout, {
...
//# sourceMappingURL=SettingsPage-G65QA7IR.js.map
