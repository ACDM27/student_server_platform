...
import {
  LimitsModal
} from "./chunk-5K2NH52Y.js";
import {
  AssigneeColumn,
  StageColumn,
  getDisplayName
} from "./chunk-DKM5SI3O.js";
import {
  getStageColorByHex
} from "./chunk-JIMGMYGG.js";
import {
...
} from "./chunk-EMZAGZ2V.js";
import {
  useTypedSelector
} from "./chunk-PYMNX6X2.js";
import {
  Combobox,
  Field as Field3,
  Flex as Flex4,
  ...
  Loader as Loader2,
  Option,
  SingleSelect as SingleSelect4,
  SingleSelectOption as SingleSelectOption4,
  TooltipImpl as TooltipImpl2,
  Typography as Typography4,
  VisuallyHidden as VisuallyHidden3
} from "./chunk-RMZXG2VM.js";
import {
  Box as Box2,
  Button as Button2,
  CheckboxImpl as CheckboxImpl2,
  Dialog,
  Field,
  Flex as Flex2,
  ForwardRef$1h as ForwardRef$1h2,
  ForwardRef$1v as ForwardRef$1v2,
  ForwardRef$2n,
  ForwardRef$3,
  ForwardRef$3P,
  ForwardRef$43,
  ...
  Popover as Popover2,
  SingleSelect as SingleSelect2,
  SingleSelectOption as SingleSelectOption2,
  Status,
  TooltipImpl,
...
} from "./chunk-RIFIJV4U.js";
import {
  index
} from "./chunk-4BE5MOJ3.js";
import {
  getTimezoneOffset,
...
import {
  ...
  Flex as Flex3,
  ForwardRef$1B,
  ForwardRef$4T as ForwardRef$4T2,
  Link as Link2,
  LinkButton,
  Modal as Modal3,
  Popover as Popover3,
  SingleSelect as SingleSelect3,
  SingleSelectOption as SingleSelectOption3,
  Typography as Typography3
} from "./chunk-5SQLHWAH.js";
import {
  AssetGridList,
  AudioPreview,
  Breadcrumbs,
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-FXNO4C5N.js";
import {
  useConfig
} from "./chunk-2UKQVHJG.js";
import {
  AssetSource,
  AssetType,
  Badge,
...
import {
  useDocumentActions
} from "./chunk-KSWU3ZZH.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-QLG6A3G2.js";
import {
  renderAdmin
} from "./chunk-YUJYWNPT.js";
import {
  useLicenseLimits
} from "./chunk-UZHR76VX.js";
import {
  Table,
  useTable
} from "./chunk-DYQFSZFV.js";
import {
  useField,
  useForm
} from "./chunk-E7DWX3ZN.js";
import {
  useRBAC
} from "./chunk-VP5LSJAQ.js";
import {
  require_omit
} from "./chunk-NGDEXB3A.js";
import {
  require_cloneDeep
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-QYSFXI7S.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-67V7DFWV.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-YNBYQEAG.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-GH2F6EZS.js");
        return {
...
var TextAlignTypography2 = dt(Typography2)`
  text-align: center;
`;
  ...
  return (0, import_jsx_runtime16.jsxs)(Dialog.Root, {
    ...
    children: [
      (0, import_jsx_runtime16.jsxs)(Field.Root, {
        ...
        name: name2,
        children: [
          (0, import_jsx_runtime16.jsx)(CheckboxImpl2, {
      ...
      (0, import_jsx_runtime16.jsxs)(Dialog.Content, {
        children: [
          ...
          (0, import_jsx_runtime16.jsx)(Dialog.Body, {
            ...
            children: (0, import_jsx_runtime16.jsxs)(Flex2, {
              direction: "column",
              alignItems: "stretch",
              gap: 2,
              children: [
                (0, import_jsx_runtime16.jsx)(Flex2, {
                  justifyContent: "center",
                ...
                (0, import_jsx_runtime16.jsx)(Flex2, {
                  justifyContent: "center",
                  children: (0, import_jsx_runtime16.jsx)(Typography2, {
                    fontWeight: "semiBold",
                    children: formatMessage({
          ...
          (0, import_jsx_runtime16.jsxs)(Dialog.Footer, {
            children: [
              (0, import_jsx_runtime16.jsx)(Dialog.Cancel, {
                children: (0, import_jsx_runtime16.jsx)(Button2, {
                  variant: "tertiary",
                  children: formatMessage({
...
var EntryValidationText = ({ status = "draft", validationErrors, action }) => {
  ...
  if (validationErrors) {
    ...
    return (0, import_jsx_runtime17.jsxs)(Flex2, {
      gap: 2,
      children: [
        ...
        (0, import_jsx_runtime17.jsx)(TooltipImpl, {
          ...
          children: (0, import_jsx_runtime17.jsx)(Typography2, {
            maxWidth: "30rem",
            textColor: "danger600",
            variant: "omega",
            fontWeight: "semiBold",
  ...
  return (0, import_jsx_runtime17.jsxs)(Flex2, {
    ...
    children: [
      icon,
      (0, import_jsx_runtime17.jsx)(Typography2, {
        textColor,
        fontWeight,
        children: text
      })
...
var BoldChunk = (chunks) => (0, import_jsx_runtime17.jsx)(Typography2, {
  fontWeight: "bold",
  children: chunks
});
var BulkLocaleActionModal = ({ headers, rows, localesMetadata, validationErrors = {}, action }) => {
  ...
  return (0, import_jsx_runtime17.jsxs)(Modal2.Body, {
    children: [
      (0, import_jsx_runtime17.jsx)(Typography2, {
        children: getFormattedCountMessage()
      }),
      (0, import_jsx_runtime17.jsx)(Box2, {
        marginTop: 5,
              ...
              children: rows.map(({ locale, status }, index4) => {
                ...
                return (0, import_jsx_runtime17.jsxs)(Table.Row, {
                  children: [
                    ...
                    (0, import_jsx_runtime17.jsx)(Table.Cell, {
                      children: (0, import_jsx_runtime17.jsx)(Box2, {
                        display: "flex",
                    ...
                    (0, import_jsx_runtime17.jsx)(Table.Cell, {
                      children: (0, import_jsx_runtime17.jsx)(IconButton2, {
                        tag: Link,
                        to: {
                        ...
                        variant: "ghost",
                        children: (0, import_jsx_runtime17.jsx)(ForwardRef$1v2, {})
                      })
                    })
                  ]
                }, index4);
...
var LocaleOption = ({ isDraftAndPublishEnabled, locale, status, entryExists }) => {
  ...
  return (0, import_jsx_runtime18.jsxs)(Flex2, {
    width: "100%",
    gap: 1,
    justifyContent: "space-between",
    children: [
      (0, import_jsx_runtime18.jsx)(Typography2, {
      ...
      isDraftAndPublishEnabled ? (0, import_jsx_runtime18.jsx)(Status, {
        ...
        children: (0, import_jsx_runtime18.jsx)(Typography2, {
          tag: "span",
          variant: "pi",
          fontWeight: "bold",
          children: capitalize(status)
  ...
  return {
    ...
    options: displayedLocales.map((locale) => {
      ...
      return {
        ...
        startIcon: !entryWithLocaleExists ? (0, import_jsx_runtime18.jsx)(ForwardRef$1h2, {}) : null
      };
    }),
      ...
      content: ({ onClose }) => (0, import_jsx_runtime18.jsxs)(import_jsx_runtime18.Fragment, {
        children: [
          (0, import_jsx_runtime18.jsx)(Dialog.Body, {
            children: (0, import_jsx_runtime18.jsxs)(Flex2, {
              direction: "column",
              gap: 3,
              children: [
                ...
                (0, import_jsx_runtime18.jsxs)(Field.Root, {
                  ...
                  children: [
                    ...
                    (0, import_jsx_runtime18.jsx)(SingleSelect2, {
                      ...
                      children: availableLocales.map((locale) => (0, import_jsx_runtime18.jsx)(SingleSelectOption2, {
                        value: locale.code,
                        children: locale.name
                      }, locale.code))
                    })
          ...
          (0, import_jsx_runtime18.jsx)(Dialog.Footer, {
            children: (0, import_jsx_runtime18.jsxs)(Flex2, {
              ...
              width: "100%",
              children: [
                (0, import_jsx_runtime18.jsx)(Button2, {
                  flex: "auto",
                  variant: "tertiary",
                  onClick: onClose,
                  children: formatMessage({
...
var DeleteLocaleAction = ({ document, documentId, model, collectionType }) => {
  ...
  return {
    ...
    dialog: {
      ...
      content: (0, import_jsx_runtime18.jsxs)(Flex2, {
        direction: "column",
        gap: 2,
        children: [
          (0, import_jsx_runtime18.jsx)(ForwardRef$3, {
...
var BulkLocaleAction = ({ document, documentId, model, collectionType, action }) => {
  ...
  return {
    ...
    dialog: {
      ...
      footer: () => (0, import_jsx_runtime18.jsx)(Modal2.Footer, {
        justifyContent: "flex-end",
        children: (0, import_jsx_runtime18.jsx)(Button2, {
...
var StyledTrash = dt(ForwardRef$j2)`
  path {
    fill: currentColor;
  }
`;
...
var Emphasis = (chunks) => {
  return (0, import_jsx_runtime19.jsx)(Typography2, {
    fontWeight: "semiBold",
    textColor: "danger500",
    children: chunks
  });
...
var LocalePicker = () => {
  ...
  return (0, import_jsx_runtime20.jsx)(SingleSelect2, {
    size: "S",
    "aria-label": formatMessage({
    ...
    onChange: handleChange,
    children: displayedLocales.map((locale) => (0, import_jsx_runtime20.jsx)(SingleSelectOption2, {
      value: locale.code,
      children: locale.name
    }, locale.id))
  });
...
var LabelAction = ({ title, icon }) => {
  ...
  return (0, import_jsx_runtime21.jsxs)(Span, {
    tag: "span",
    children: [
      (0, import_jsx_runtime21.jsx)(VisuallyHidden2, {
        tag: "span",
...
var LocaleListCell = ({ locale: currentLocale, localizations }) => {
  ...
  return (0, import_jsx_runtime22.jsxs)(Popover2.Root, {
    children: [
      (0, import_jsx_runtime22.jsx)(Popover2.Trigger, {
        children: (0, import_jsx_runtime22.jsx)(Button2, {
          variant: "ghost",
          type: "button",
          onClick: (e) => e.stopPropagation(),
          children: (0, import_jsx_runtime22.jsxs)(Flex2, {
            minWidth: "100%",
            alignItems: "center",
            justifyContent: "center",
            fontWeight: "regular",
            children: [
              (0, import_jsx_runtime22.jsx)(Typography2, {
                textColor: "neutral800",
                ellipsis: true,
                marginRight: 2,
                children: localesForDocument.join(", ")
              }),
              (0, import_jsx_runtime22.jsx)(Flex2, {
      ...
      (0, import_jsx_runtime22.jsx)(Popover2.Content, {
        sideOffset: 16,
        children: (0, import_jsx_runtime22.jsx)("ul", {
          children: localesForDocument.map((name2) => (0, import_jsx_runtime22.jsx)(Box2, {
            padding: 3,
            tag: "li",
            children: (0, import_jsx_runtime22.jsx)(Typography2, {
              children: name2
            })
          }, name2))
        })
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-G65QA7IR.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
...
var AddActionToReleaseModal = ({ contentType, documentId, onInputChange, values }) => {
  ...
  return (0, import_jsx_runtime24.jsxs)(Flex3, {
    direction: "column",
    alignItems: "stretch",
    gap: 2,
    children: [
      (0, import_jsx_runtime24.jsx)(Box3, {
        paddingBottom: 6,
        children: (0, import_jsx_runtime24.jsxs)(Field2.Root, {
          required: true,
          children: [
            (0, import_jsx_runtime24.jsx)(Field2.Label, {
              children: formatMessage({
                id: "content-releases.content-manager-edit-view.add-to-release.select-label",
                defaultMessage: "Select a release"
              })
            }),
            (0, import_jsx_runtime24.jsx)(SingleSelect3, {
              required: true,
              placeholder: formatMessage({
              ...
              children: releases == null ? void 0 : releases.map((release) => (0, import_jsx_runtime24.jsx)(SingleSelectOption3, {
                value: release.id,
...
var ReleaseActionModalForm = ({ documentId, document, model, collectionType }) => {
  ...
  return {
    ...
    dialog: {
      ...
      footer: ({ onClose }) => (0, import_jsx_runtime24.jsxs)(Modal3.Footer, {
        children: [
          (0, import_jsx_runtime24.jsx)(Button3, {
            onClick: onClose,
            variant: "tertiary",
            name: "cancel",
            children: formatMessage({
      ...
      content: ({ onClose }) => {
        return (0, import_jsx_runtime25.jsx)(Formik, {
          ...
          children: ({ values, setFieldValue }) => (0, import_jsx_runtime25.jsxs)(Form, {
            children: [
              (releases == null ? void 0 : releases.length) === 0 ? (0, import_jsx_runtime25.jsx)(NoReleases, {}) : (0, import_jsx_runtime25.jsx)(Modal3.Body, {
                children: (0, import_jsx_runtime25.jsxs)(Flex3, {
                  direction: "column",
                  alignItems: "stretch",
                  gap: 2,
                  children: [
                    (0, import_jsx_runtime25.jsx)(Box3, {
                      paddingBottom: 6,
                      children: (0, import_jsx_runtime25.jsxs)(Field2.Root, {
                        required: true,
                        children: [
                          (0, import_jsx_runtime25.jsx)(Field2.Label, {
                            children: formatMessage({
                              id: "content-releases.content-manager-list-view.add-to-release.select-label",
                              defaultMessage: "Select a release"
                            })
                          }),
                          (0, import_jsx_runtime25.jsx)(SingleSelect3, {
                            placeholder: formatMessage({
                            ...
                            value: values.releaseId,
                            children: releases == null ? void 0 : releases.map((release) => (0, import_jsx_runtime25.jsx)(SingleSelectOption3, {
                              value: release.id,
                              children: release.name
                            }, release.id))
                          })
              ...
              (0, import_jsx_runtime25.jsxs)(Modal3.Footer, {
                children: [
                  (0, import_jsx_runtime25.jsx)(Button3, {
                    onClick: onClose,
                    variant: "tertiary",
                    name: "cancel",
                    children: formatMessage({
...
var ReleaseListCell = ({ documentId, model }) => {
  ...
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime26.jsxs)(Popover3.Root, {
    children: [
      (0, import_jsx_runtime26.jsx)(Popover3.Trigger, {
        children: (0, import_jsx_runtime26.jsx)(Button3, {
          variant: "ghost",
          onClick: (e) => e.stopPropagation(),
          // TODO: find a way in the DS to define the widht and height of the icon
          endIcon: releases.length > 0 ? (0, import_jsx_runtime26.jsx)(ForwardRef$4T2, {
            width: "1.2rem",
            height: "1.2rem"
          }) : null,
          children: (0, import_jsx_runtime26.jsx)(Typography3, {
            style: {
              maxWidth: "252px",
              cursor: "pointer"
            },
      ...
      (0, import_jsx_runtime26.jsx)(Popover3.Content, {
        children: (0, import_jsx_runtime26.jsx)("ul", {
          children: releases.map(({ id, name: name2 }) => (0, import_jsx_runtime26.jsx)(Box3, {
            padding: 3,
            tag: "li",
...
var Panel = ({ model, document, documentId, collectionType }) => {
  ...
  return {
    ...
    content: (0, import_jsx_runtime27.jsx)(Flex3, {
      direction: "column",
      alignItems: "stretch",
      gap: 3,
      width: "100%",
      children: releases == null ? void 0 : releases.map((release) => (0, import_jsx_runtime27.jsxs)(Flex3, {
        direction: "column",
        alignItems: "start",
        borderWidth: "1px",
        borderStyle: "solid",
        ...
        hasRadius: true,
        children: [
          (0, import_jsx_runtime27.jsx)(Box3, {
            paddingTop: 3,
            paddingBottom: 3,
            paddingLeft: 4,
            paddingRight: 4,
            ...
            width: "100%",
            children: (0, import_jsx_runtime27.jsx)(Typography3, {
              fontSize: 1,
              variant: "pi",
          ...
          (0, import_jsx_runtime27.jsxs)(Flex3, {
            padding: 4,
            direction: "column",
            gap: 2,
            width: "100%",
            alignItems: "flex-start",
            children: [
              (0, import_jsx_runtime27.jsx)(Typography3, {
                fontSize: 2,
                fontWeight: "bold",
                variant: "omega",
              ...
              release.scheduledAt && release.timezone && (0, import_jsx_runtime27.jsx)(Typography3, {
                variant: "pi",
                textColor: "neutral600",
                children: formatMessage({
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-HH4K33AD.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-U3YRCYO4.js");
          return {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-QEDR357V.js");
          return {
...
var AssigneeSelect = ({ isCompact }) => {
  ...
  if (isCompact) {
    return (0, import_jsx_runtime28.jsxs)(Field3.Root, {
      name: ASSIGNEE_ATTRIBUTE_NAME,
      id: ASSIGNEE_ATTRIBUTE_NAME,
      children: [
        (0, import_jsx_runtime28.jsx)(VisuallyHidden3, {
          children: (0, import_jsx_runtime28.jsx)(Field3.Label, {
  ...
  return (0, import_jsx_runtime28.jsxs)(Field3.Root, {
    ...
    children: [
      (0, import_jsx_runtime28.jsx)(Field3.Label, {
        children: assigneeLabel
      }),
      (0, import_jsx_runtime28.jsx)(Combobox, {
        clearLabel: assigneeClearLabel,
      ...
      (0, import_jsx_runtime28.jsx)(Field3.Error, {})
    ]
  });
};
...
var Select = ({ stages, activeWorkflowStage, isLoading, ...props }) => {
  ...
  return (0, import_jsx_runtime29.jsx)(SingleSelect4, {
    disabled: stages.length === 0,
    placeholder: formatMessage({
      id: "content-manager.reviewWorkflows.assignee.placeholder",
      defaultMessage: "Select…"
    }),
    startIcon: activeWorkflowStage && (0, import_jsx_runtime29.jsx)(Flex4, {
      tag: "span",
      height: 2,
    ...
    customizeContent: () => {
      return (0, import_jsx_runtime29.jsxs)(Flex4, {
        tag: "span",
        justifyContent: "space-between",
        alignItems: "center",
        width: "100%",
        children: [
          (0, import_jsx_runtime29.jsx)(Typography4, {
            textColor: "neutral800",
            ellipsis: true,
            lineHeight: "inherit",
            children: (activeWorkflowStage == null ? void 0 : activeWorkflowStage.name) ?? ""
          }),
          isLoading ? (0, import_jsx_runtime29.jsx)(Loader2, {
            small: true,
            style: {
              display: "flex"
            },
    ...
    children: stages.map(({ id, color, name: name2 }) => {
      ...
      return (0, import_jsx_runtime29.jsx)(SingleSelectOption4, {
        startIcon: (0, import_jsx_runtime29.jsx)(Flex4, {
          height: 2,
          background: color,
...
var StageSelect = ({ isCompact }) => {
  ...
  if (isCompact) {
    return (0, import_jsx_runtime29.jsxs)(import_jsx_runtime29.Fragment, {
      children: [
        (0, import_jsx_runtime29.jsx)(TooltipImpl2, {
          label: reviewStageHint,
          children: (0, import_jsx_runtime29.jsx)(Field3.Root, {
            name: STAGE_ATTRIBUTE_NAME,
            id: STAGE_ATTRIBUTE_NAME,
            children: (0, import_jsx_runtime29.jsxs)(import_jsx_runtime29.Fragment, {
              children: [
                (0, import_jsx_runtime29.jsx)(VisuallyHidden3, {
                  children: (0, import_jsx_runtime29.jsx)(Field3.Label, {
  ...
  return (0, import_jsx_runtime29.jsxs)(import_jsx_runtime29.Fragment, {
    children: [
      (0, import_jsx_runtime29.jsxs)(Field3.Root, {
        hint: reviewStageHint,
        error: error && formatAPIError(error) || void 0,
        name: STAGE_ATTRIBUTE_NAME,
        id: STAGE_ATTRIBUTE_NAME,
        children: [
          (0, import_jsx_runtime29.jsx)(Field3.Label, {
            children: reviewStageLabel
          }),
          (0, import_jsx_runtime29.jsx)(Select, {
            stages,
          ...
          (0, import_jsx_runtime29.jsx)(Field3.Hint, {}),
          (0, import_jsx_runtime29.jsx)(Field3.Error, {})
        ]
      }),
      (0, import_jsx_runtime29.jsx)(WorkflowLimitModal, {
        open: showLimitModal === "workflow",
...
var Header = () => {
  ...
  return (0, import_jsx_runtime30.jsxs)(Flex4, {
    gap: 2,
    children: [
...
var Panel2 = () => {
  ...
  return {
    ...
    content: (0, import_jsx_runtime31.jsxs)(Flex4, {
      direction: "column",
      gap: 2,
      alignItems: "stretch",
      width: "100%",
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-PN6QAXHE.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-3P6W4LYV.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-FESURBUF.js");
          return {
...
//# sourceMappingURL=chunk-WJLQDPHY.js.map
