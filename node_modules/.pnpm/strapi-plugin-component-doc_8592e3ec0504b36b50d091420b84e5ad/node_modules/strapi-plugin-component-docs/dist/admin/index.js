...
const PLUGIN_ID = "component-docs";
...
`;
const PluginIcon = () => {
  return /* @__PURE__ */ jsxRuntime.jsx(IconBox, { justifyContent: "center", alignItems: "center", width: 7, height: 6, hasRadius: true, "aria-hidden": true, children: /* @__PURE__ */ jsxRuntime.jsx(icons.Link, {}) });
};
var map;
try {
  map = Map;
...
const index = {
  register(app) {
    ...
    app.customFields.register({
      ...
      components: {
        Input: async () => Promise.resolve().then(() => require("../_chunks/Input-CYA858h7.js"))
      },
      options: {
        base: [
          {
  ...
  async registerTrads({ locales }) {
    return Promise.all(
      locales.map(async (locale) => {
        try {
          const { default: data } = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => Promise.resolve().then(() => require("../_chunks/en-B5iIqpJi.js")) }), `./translations/${locale}.json`, 3);
          return {
            data: data || {},
            locale
          };
